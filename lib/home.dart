...
class _HomeState extends State<Home> with SingleTickerProviderStateMixin {
  ...
  List post_item = [
    ...
    [
      ...
      '4',
      '1K',
      'https://cdn.pixabay.com/photo/2022/10/11/06/35/alien-7513483__340.jpg',
      '30',
      '5'
    ],
    [
      ...
      '2',
      '1K',
      'https://cdn.pixabay.com/photo/2022/05/17/11/11/nft-7202369__340.png',
      '20',
      '2'
    ],
  ];
        ...
        children: [
          CircleAvatar(
            backgroundImage: NetworkImage(
                "https://cdn.pixabay.com/photo/2014/10/02/00/15/gas-mask-469217__340.jpg"),
          ),
          Row(
            children: [
              CircleAvatar(
